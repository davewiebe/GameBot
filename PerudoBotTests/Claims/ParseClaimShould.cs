...
namespace PerudoBotTests
{
    ...
    public class ParseClaimShould
    {
        ...
        [TestCase("1 34", Operator.Exactly, 1, 34, false)]
        [Test]
        public void HandleClaimsWithOperatorsAndNoWilds(string claimText, Operator expectedOperator, int expectedQuantity, int expectedPips, bool expectedIncludeWilds)
        {
        ...
        [TestCase("<4 6", Operator.LessThan, 4, 6, false)]
        [Test]
        ...
        [TestCase("~4 3", Operator.Approximately, 11, 3, false)]
        [Test]
